...
package org.openstreetmap.josm.plugins.amatosmeditor.gui.io;
 ...
 * @since 10129
 */
public abstract class AMATAbstractPrimitiveTask extends PleaseWaitRunnable {
    ...
    protected final AMATOsmDataLayer layer;
    ...
    protected AMATAbstractPrimitiveTask(String title, AMATOsmDataLayer layer) {
        this(title, new PleaseWaitProgressMonitor(title), layer);
    }

    protected AMATAbstractPrimitiveTask(String title, ProgressMonitor progressMonitor, AMATOsmDataLayer layer) {
     ...
     * @return {@code this}
     */
    public final AMATAbstractPrimitiveTask setZoom(boolean zoom) {
        this.zoom = zoom;
        return this;
    }
     ...
     * @return {@code this}
     */
    public final AMATAbstractPrimitiveTask setDownloadRelations(boolean downloadRelations, boolean fullRelation) {
