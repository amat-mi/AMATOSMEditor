 ...
 * @since 2599
 */
public class AMATUpdatePrimitivesTask extends AMATAbstractPrimitiveTask {
     ...
     */
    public AMATUpdatePrimitivesTask(AMATOsmDataLayer layer, Collection<? extends OsmPrimitive> toUpdate) {
