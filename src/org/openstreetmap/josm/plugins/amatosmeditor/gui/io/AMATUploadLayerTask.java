...
/**
 * UploadLayerTask uploads the data managed by an {@link AMATOsmDataLayer} asynchronously.
 *
 * <pre>
 ...
 * </pre>
 */
public class AMATUploadLayerTask extends AbstractIOTask {
    private OsmServerWriter writer;
    private final AMATOsmDataLayer layer;
     ...
     */
    public AMATUploadLayerTask(UploadStrategySpecification strategy, AMATOsmDataLayer layer, ProgressMonitor monitor, Changeset changeset) {
